// Code generated by "mkvisitor -output chords_mkvisitor_generated.go -type ChordList,Chord,ChordDegree,ChordSymbol,ChordBase,ChordValues,ChordValue,Rest,ChordMeta,ChordMetadata"; DO NOT EDIT.
...
func (s *ChordMeta) Accept(v Visitor)     { v.VisitChordMeta(s) }
func (s *ChordMetadata) Accept(v Visitor) { v.VisitChordMetadata(s) }
...
func VisitSwitch(visitor Visitor, v interface{}) {
	...
	case *Rest:
		visitor.VisitRest(v)
	case *ChordMeta:
		visitor.VisitChordMeta(v)
	case *ChordMetadata:
		visitor.VisitChordMetadata(v)
	default:
